...
return new class extends Migration
{
    ...
    {
        // On vérifie si la table n'existe pas AVANT de tenter de la créer
        if (!Schema::hasTable('distributions_intrants_cooperative')) {
            Schema::create('distributions_intrants_cooperative', function (Blueprint $table) {
                ...
                // NOM COURT EXPLICITE : Très important pour MySQL (max 64 caractères)
