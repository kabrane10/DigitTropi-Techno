    ...
    <div class="lg:col-span-1 space-y-6">
        <div class="bg-white rounded-xl shadow-sm p-6 border-t-4 border-primary">
            ...
            <div class="mt-8 grid grid-cols-2 gap-3">
                <a href="{{ route('agent.producteurs.edit', $producteur) }}" class="flex justify-center items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
                    <i class="fas fa-edit mr-2"></i> Modifier
                </a>
                <a href="{{ route('agent.producteurs.index') }}" class="flex justify-center items-center px-4 py-2 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition">
                    Retour
                </a>
            </div>
        </div>
