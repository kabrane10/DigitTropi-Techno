...
<head>
    ...
    <title>Connexion Agent - Tropi-Techno</title>
...
<body class="bg-gradient-to-br from-primary/20 to-secondary/20 font-inter min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full animate-fade-up">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-1">Espace Agent Terrain</p>
        </div>
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
            <div class="bg-gradient-to-r from-primary to-secondary px-6 py-4">
                ...
                <p class="text-white/80 text-sm">Accédez à votre espace agent terrain</p>
            </div>
            
            <form action="{{ route('agent.login.submit') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" required value="{{ old('email') }}"
                               class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition"
                               placeholder="agent@tropitechno.com">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" required
                               class="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition"
                               placeholder="••••••••">
                        <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-primary">
        ...
        <div class="text-center mt-6">
            <p class="text-xs text-gray-500">&copy; {{ date('Y') }} Tropi-Techno Sarl - Agriculture Biologique au Togo</p>
        </div>
    </div>
