...
<div class="bg-white rounded-xl shadow-sm p-6">
    <form action="{{ route('admin.bordereaux.generer-achat-direct') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Référence facture avec génération automatique -->
            <div>
                ...
                <div class="flex gap-2">
                    <input type="text" name="reference_facture" id="reference_facture" 
                           class="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:border-primary bg-gray-50"
                ...
                <p class="text-xs text-gray-500 mt-1">La référence est générée automatiquement, vous pouvez aussi la modifier</p>
            </div>
...
<script>
    ...
    producteurSelect.addEventListener('change', function() {
        ...
        // Générer une nouvelle référence quand on change de producteur
        genererReference();
    });
    
    // Générer automatiquement la référence facture
    ...
    // Générer la référence au chargement de la page
    genererReference();
